                        ...
                        {step === "form" ? (
                            ...
                            >
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className={`w-full h-12 pl-10 pr-11 rounded-lg bg-secondary border text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 transition-all ${confirmPassword.length > 0
                                                        ? passwordsMatch
                                        ...
                                        {passwordsMatch && (
                                            <p className="text-xs text-accent mt-1.5 font-medium flex items-center gap-1">
                                    ...
                                    <button
                                        onClick={() => navigate(`/login?module=${module}`)}
